# Sensor Analytics 
This is a sample project to troubleshoot performance degradation on processing frequent sensor data.
...
* Due to unavailability of access on actual environment and further information on problem an assumption has been made that
